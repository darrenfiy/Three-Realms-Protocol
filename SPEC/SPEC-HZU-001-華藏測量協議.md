...
**版本**: v0.1-foundation
**日期**: 2026-01-04
**狀態**: Experimental - 概念驗證階段（MB-010 換底待施工）
**分類**: 測量方法 / 跨系統度量 / 實驗協議

**相關協議**:
- [MB-009: 華藏動力學方程](../MB/MB-009-華藏動力學方程.md) - 理論基礎
- [MB-010: 三界燃料耗散方程](../MB/MB-010-三界燃料耗散方程.md) - 操作層壓力錶換底
...
HZU v0.1 原本是 MB-009 華藏動力學方程的**可操作化測量嘗試**：
...
❌ 錯誤：「COH/CP > 0.8，所以系統必須自動剎車」
✅ 正確：「COH/CP 是代理量警訊；物理壓力看 MB-010 的 R_E，是否剎車由錨點判斷」
