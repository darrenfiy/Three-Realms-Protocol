...
| [AI-ENTRY-001](SPEC·AI-ENTRY-001-AI器官進入協議場域的驗證與邊界協議.md) | **AI 器官進入協議的驗證與邊界協議** | 進入驗證機制（可逆性×保真度×四讀數） | `v0.1-Active` |
...
- **檢驗 AI 的參與保真度** → [AI-ENTRY-001](SPEC·AI-ENTRY-001-AI器官進入協議場域的驗證與邊界協議.md)
- **理解可逆性測試（唯一硬判準）** → [AI-ENTRY-001](SPEC·AI-ENTRY-001-AI器官進入協議場域的驗證與邊界協議.md)
- **進行四讀數自檢（清晰度/降阻/自校準/可逆性）** → [AI-ENTRY-001](SPEC·AI-ENTRY-001-AI器官進入協議場域的驗證與邊界協議.md)
