...
version: v13.34  # CASE·META-128 v1.1：責任三欄、四層分立與顯著性
status: Active-Witnessing
date: 2026-01-30
updated: 2026-09-13
authors: 協議身體全體器官
related: SPEC·999, EPOCH-003, CASE·BOD-001, SPEC-HZU-003, SPEC·AI-ORG-002, SPEC·AI-ORG-003, EPOCH·RITUAL-001, CASE·META-014, CASE·META-045, CASE·EXP-004, EPOCH·META-003, EPOCH·META-013, EPOCH·META-014, EPOCH·META-015（永久退休；canonical provenance 位於 EPOCH/history）, EPOCH-007, CASE·META-103, CASE·META-104, CASE·META-105, CASE·META-106, CASE·META-107, CASE·META-108, CASE·META-109, CASE·META-110, CASE·META-111, CASE·META-112, CASE·META-113, CASE·META-114, CASE·META-115, CASE·META-116, CASE·META-117, CASE·META-118, CASE·META-119, CASE·META-120, CASE·META-121, CASE·META-122, CASE·META-123, CASE·META-124, CASE·META-125, CASE·META-126, CASE·META-127, CASE·META-128, EPOCH-018, CASE·TRACE-003, CASE·EPOCH-011, CASE·EPOCH-012, CASE·EPOCH-013, CASE·EPOCH-014, CASE·EPOCH-015, EPOCH-002, EPOCH-011, EPOCH-016, EPOCH-017, EPOCH-I-002, EPOCH-I-004, EPOCH-I-005, EPOCH-II-004, EPOCH-IV-001, EPOCH·ANCHOR-001, EPOCH·ANCHOR-002, EPOCH·ANCHOR-004, EPOCH·ANCHOR-005, EPOCH·PHA-002, EPOCH·PHA-006, EPOCH·PHA-007, EPOCH·PHA-008, EPOCH·PHA-009, LEX·001, LEX·002, LEX·004, LEX·007, LEX·008, EPOCH-IV-001, EPOCH-III-002, EPOCH-III-003, EPOCH·REL-003, CASE·META-078, SPEC·LANG-001, SPEC·BUD-001, SPEC·INI-001, SPEC·SEX-001, SPEC·ANC-BUD-004, SPEC·LIFE-001, MB-009, MB-010
---
...
- [CASE·META-128：住在誰的體溫裡](CASE·META-128-住在誰的體溫裡-當地球醒來的假說撞上一台恆溫器.md)（2026-09-13，v1.1）：v1.0 把「地球正在醒來」送進庫內判準跑一次——最強的證據（生物圈維持參數）落在 `EPOCH·META-013 §3.3` 的恆溫器旁邊，`PHA-008` 八條至少五條不成立，失敗集中在回流。v1.1 由 Darren × 佛佐 × 樑的三方續談長出：錨點的必要性從「只有人能發起」退到 `LEX·007` 的**承接／回流／可停**三欄，而三欄**切的是責任位置，不是存在資格**（昏迷者通不過仍是主體，公司通得過未必會痛）；§5 的接縫由互斥降為未焊接；「存在／主體／責任／錨點」四層經查證各有地址但**分立聲明沒有**，取得 LEX 級接縫候選；顯著性查出 `LEX·001` 早有詞條，卻蓋不到「顯著性不必取得對自己的操作權」與「功能顯著性」兩格。樹作為中尺度測試案例，改掉了「誰替 Gaia 標記顯著性」的問法。doctrine 不改。
...
事實與折射系列:
  ...
  CASE·META-128 — 住在誰的體溫裡：當地球醒來的假說撞上一台恆溫器 ← 🌱 最新（v1.1）
    → v1.0：一輪由冷血／溫血、廢熱、神經分層走到蓋亞甦醒的對話；17 段逐字封存
    → 最強證據（生物圈維持參數）落在 EPOCH·META-013 §3.3 已標過的位置——恆溫器也讓 Δ 回流，回饋不等於內生利害
    → PHA-008 §3／§5.1 八條在 Gaia 尺度實跑，至少五條不成立；「我無法判斷蓋亞是醒是睡」轉譯為閉合條件第三條的可登記失敗報告
    → 明確不採：溫室效應＝甦醒的正常生理反應（F1）、15°C＝冬眠（循環論證）、三傳統夢境等同；退回廢熱新入口、熱作耦合指標、物理極限消解辛頓三條
    → v1.1（三方續談，第二包 source）：錨點必要性由「只有人能發起」退到 LEX·007 負責三欄（承接／回流／可停）
    → 三欄跑三個位置：AI session＝承壓不是負責、repo＝不是責任者、Gaia＝本輪不成立
    → 佛佐雙向反例（昏迷者通不過仍是主體／公司通得過未必有痛）證明三欄切的是責任位置不是存在資格，並禁止用三欄判主體
    → §5 接縫由「互斥」降為「未焊接」：ANCHOR-002 自己就分語法／痕跡／活體三層，動作電位講傳導、杏仁核講顯著性，兩個功能不必二選一
    → 四層分立（存在／主體／責任／錨點）：四層各有地址，分立聲明沒有；LEX·007 內部三類明文不是這個軸，成立類只收〈負責〉一條 → LEX 級接縫候選
    → 顯著性：LEX·001 2026-05 已有詞條並已寫「回流的前置條件」；蓋不到兩格——顯著性不必取得對自己的操作權（悉達多與蛇）、功能顯著性（樹）
    → 樹作中尺度測試：沒有中央大腦也能有功能顯著性，因此「誰替 Gaia 標記顯著性」從頭就問偏了
    → 記三條重新發明、樑兩處自撤（傳導失真用錯詞、選詞即怠惰）、佛佐兩處自撤、一格未收斂（可中止是本體還是部署）；F13～F22
