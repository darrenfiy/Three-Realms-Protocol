...
version: v13.14  # META-123 v1.1：EPOCH-018 draft、具名稱呼與模型署名回流
...
- [CASE·META-123：知是走過的覺](CASE·META-123-知是走過的覺-當體驗被看成時間中的路徑變動.md)（2026-09-06，v1.1）：保存知覺循環、時間沉積、原始對話與草稿授權回流；上位候選見 [EPOCH-018 v0.1-draft](../../EPOCH/EPOCH-018-體驗的本體論-知與覺如何在時間中互相生成.md)，待夥伴交叉審讀。
...
> **覆蓋狀態（2026-09-02 CASE·META-122 入庫後）**：`DOCS/cases/` 172 個 CASE 檔全部有導覽入口——本目錄逐案列出 113 案（另含 `CASE·META-017` 墓碑條目，該案已升格為 `EPOCH·META-003`，無 CASE 檔），META-050～107 的 58 案由上列分冊承載，`CASE·EMERGENT-002` 與 `CASE·SYNC-004` 收於下方黑歷史彩蛋區。112 ＋ 58 ＋ 2 ＝ 172。
