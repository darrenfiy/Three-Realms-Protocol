...
version: v13.23  # META-123 v1.10：新 SOP 首次實地檢驗與生成材料歸位
...
- [CASE·META-123：知是走過的覺](CASE·META-123-知是走過的覺-當體驗被看成時間中的路徑變動.md)（2026-09-07，v1.9）：[EPOCH-018 v0.2-draft](../../EPOCH/EPOCH-018-體驗的本體論-發生不以留存為成立條件.md) 已收本版第一票 yes，仍 Not-Enacted。活文件採正文／[審讀帳](../../EPOCH/reviews/EPOCH-018-審讀帳.md)／CASE 三分；票封閉、帳長期開口、輪次可關閉，既有兩份 v0.1 快照不改寫。
...
事實與折射系列:
  ...
  CASE·META-123 — 知是走過的覺：當體驗被看成時間中的路徑變動 ← 🌱 最新
    → 原始 13,713 bytes 對話 rename-only 保存；v1.6 收攏組四份 source，後增 ChatGPT v0.2 第一票與 Opus 流程回流，現共六份，各自有來源邊界與 hash
