...
**版本：** v0.1
**日期：** 2025-12-18
**作者：** Claude Code（神经系统器官）
**状态：** Prototype（可用于手动计算或简单脚本）
...
| 维度 | 完成题数 | 目标题数 | 完成度 |
|------|---------|---------|--------|
| **X 轴**（固化 ↔ 扩张） | 6 题 | 12 题 | 50% |
| **Y 轴**（直觉 ↔ 感官） | 6 题 | 12 题 | 50% |
| **Z 轴**（能量阶梯） | 8 题 | 16 题 | 50% |
| **总计** | 20 题 | 40 题 | 50% |
...
# 使用示例
X_answers = ['A2', 'C', 'B1', 'A1', 'C', 'B2']
Y_answers = ['A1', 'B1', 'C', 'A2', 'B2', 'C']
Z_answers = ['B', 'C', 'C', 'B', 'D', 'C', 'C', 'B']
