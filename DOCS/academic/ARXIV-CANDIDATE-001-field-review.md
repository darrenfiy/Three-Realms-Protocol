...
Darren_externalization_decision:
  ...
  latex_source:
    path: DOCS/academic/energy_to_token_accounting_position_paper.tex
    status: generated by Codex; compile not verified locally because TeX engine is unavailable
  zenodo_pdf:
    path: DOCS/academic/energy_to_token_accounting_position_paper.pdf
    status: rebuild from TeX after DOI insertion, then upload to reserved Zenodo DOI
  zenodo_reserved_doi: 10.5281/zenodo.20580526
  gates_before_submission:
