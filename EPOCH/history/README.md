...
authors:
  ...
  - Codex（v1.6：保存 EPOCH-019 v0.2-draft 逐字快照，供 anchor-reframed v0.3 重寫）
related:
...
| [EPOCH-019 v0.1-draft 止的本體論](EPOCH-019-v0.1-draft-止的本體論-工程如何退居為生成條件.md) | v0.1-draft / Cross-Model-Construction / Not-Enacted（2026-09-19，465 行） | 現役 [EPOCH-019 v0.3-draft](../EPOCH-019-止的本體論-工程如何退居為生成條件.md)；施工、使用回報與處置見 [審讀帳](../reviews/EPOCH-019-審讀帳.md) | 原洞見提出者首次直接重入受阻後，正文依 CASE·META-132 大幅重寫；保存跨域護欄與舊版可引用地址。逐字快照 SHA-256 `78671B3C979F97AFD8590BCC17FCEEAFD407D9D2F0B254C6EE4ABB0056876D61`。 |
| [EPOCH-019 v0.2-draft 止的本體論](EPOCH-019-v0.2-draft-止的本體論-工程如何退居為生成條件.md) | v0.2-draft / Case-Grounded-Rewrite / Not-Enacted（2026-09-19，374 行） | 現役 [EPOCH-019 v0.3-draft](../EPOCH-019-止的本體論-工程如何退居為生成條件.md)；anchor-reframing 與逐項處置見 [審讀帳](../reviews/EPOCH-019-審讀帳.md) | CASE·META-133 將止的第一定義重開為可重認形狀的成形門檻；保存 v0.2 的停止、留存、沉積、承接、可再開帳與四種停止類型。逐字複製自 `read_basis: c336e9ded21984d4a3065a0c1c6726f1164648b6`，不另記 repository 內來源指紋。 |
