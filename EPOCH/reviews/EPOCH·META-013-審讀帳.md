...
version: v1.0
status: Open / Append-Only / Changes-Requested
created: 2026-09-14
updated: 2026-09-14
maintainers:
...
|---|---|---|---|
| v0.5-weld-candidate | `a311f8cc35118241be1a31fef717cd05ebade3c6` | open | GPT-6 Astra 支持充分性校正與來源分帳；正面模型需修訂。審閱完成，修訂處置尚未回流。 |
